...
export function HeroC() {
  ...
  return (
    <section className="bw-hero-bg relative overflow-hidden px-6 pt-16 pb-24 md:pt-24 md:pb-32">
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 md:grid-cols-[1fr_1fr] md:gap-16">
        <div>
          <motion.span
          ...
          >
            ...
            Five steps from URL to PNG
          </motion.span>

          <LetterReveal
            as="h1"
            text="A workshop, not a black box."
          ...
          >
            See the pipeline. Brand-extract from a URL, capture intent in a brief, stream HTML,
            render PNG. Every step is inspectable, editable, and yours.
          </motion.p>
